    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div
            ...
            <div className="relative">
                ...
                <div className="relative overflow-hidden bg-blue-400 shadow-md rounded-xl h-full">
            ...
            <div className="overflow-hidden bg-yellow-200 shadow-md rounded-xl">
            ...
            <div className="relative">
                ...
                <div className="relative overflow-hidden bg-red-400 shadow-md rounded-xl h-full">
                    <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11 8L20 8" stroke="#111827" stroke-width="2" stroke-linecap="round"></path>
                            <path d="M4 16L14 16" stroke="#111827" stroke-width="2" stroke-linecap="round"></path>
            ...
            <div className="overflow-hidden bg-slate-300 shadow-md rounded-xl">
                <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <rect x="13" y="14" width="2" height="2" rx="1" fill="#111827"></rect>
                        <rect x="7" y="11" width="2" height="6" rx="1" fill="#111827"></rect>
            ...
            <div className="relative">
                ...
                <div className="relative overflow-hidden bg-blue-200 shadow-md rounded-xl h-full">
                    <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11 8L20 8" stroke="#111827" stroke-width="2" stroke-linecap="round"></path>
                            <path d="M4 16L14 16" stroke="#111827" stroke-width="2" stroke-linecap="round"></path>
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div
            ...
            <div className="relative">
                ...
                <div className="relative overflow-hidden bg-blue-400 shadow-md rounded-xl h-full">
                    <div className="p-9"><svg className="w-6 h-6 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11 8L20 8" stroke="#111827" stroke-width="2" stroke-linecap="round"></path>
                            <path d="M4 16L14 16" stroke="#111827" stroke-width="2" stroke-linecap="round"></path>
                            <ellipse cx="7" cy="8" rx="3" ry="3" transform="rotate(90 7 8)" stroke="#111827"
                        ...
                        <h3 className="mt-2 text-xl font-bold text-gray-900 sm:mt-5">C</h3>
                        <p className="mt-2 text-base text-gray-600">A programming language</p>
                    </div>
                </div>
            </div>
            ...
            </div>  <div className="overflow-hidden bg-yellow-200 shadow-md rounded-xl">
                <div className="p-9"><svg className="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <rect x="13" y="14" width="2" height="2" rx="1" fill="#111827"></rect>
                        <rect x="7" y="11" width="2" height="6" rx="1" fill="#111827"></rect>
